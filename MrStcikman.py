...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        Sprite.__init__(self, game)
        self.images_left = [PhotoImage(file = 'L1.gif'),PhotoImage(file = 'L2.gif'),PhotoImage(file = 'L3.gif')]
        self.images_right = [PhotoImage(file = 'R1.gif'),PhotoImage(file = 'R2.gif'),PhotoImage(file = 'R3.gif')]
